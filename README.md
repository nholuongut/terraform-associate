...
- You will learn to main Terraform in a practical perspective with 40+ demo's
...
- Infrastructure Architects or Sysadmins or Developers who are planning to main Terraform
- Any beginner who is interested in learning IaC Infrastructure as Code current trending tool Terraform 
- Anyone who want to learn Terraform from a practical perspective 

## Github Repositories used for this course
- [HashiCorp Certified: Terraform Associate](https://github.com/nholuongut/terraform-associate)
- [Terraform Cloud Demo](https://github.com/nholuongut/terraform-cloud-demo1)
- [Terraform Private Module Registry](https://github.com/nholuongut/terraform-aws-s3-website)
- [Terraform Sentinel Policies](https://github.com/nholuongut/terraform-sentinel-policies)
- [Course PPT Presentation](https://github.com/nholuongut/terraform-associate/tree/main/presentation)
