...
git clone https://github.com/nholuongut/terraform-aws-s3-website.git
```
...
https://github.com/nholuongut/terraform-aws-s3-website.git
```
...
- Authorize Terraform Cloud (hctaprep) - Click on **Authorize nholuongut**
