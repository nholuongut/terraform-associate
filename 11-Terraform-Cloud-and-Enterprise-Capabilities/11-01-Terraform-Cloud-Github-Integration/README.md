...
```t
# Clone Github Repo
git clone https://github.com/nholuongut/terraform-associate.git
git clone https://github.com/nholuongut/terraform-cloud-demo1.git
```
...
https://github.com/nholuongut/terraform-cloud-demo1.git
```
...
- **Connect to VCS**
  ...
  - **Selected 1 Repository:** nholuongut/terraform-cloud-demo1
  - Click on **Install**
- **Choose a Repository**
  - nholuongut/terraform-cloud-demo1
- **Configure Settings**
